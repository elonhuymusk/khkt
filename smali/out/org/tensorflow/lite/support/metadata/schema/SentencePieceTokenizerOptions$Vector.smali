...
.method public get(Lorg/tensorflow/lite/support/metadata/schema/SentencePieceTokenizerOptions;I)Lorg/tensorflow/lite/support/metadata/schema/SentencePieceTokenizerOptions;
    ...
    iget-object v1, p0, Lorg/tensorflow/lite/support/metadata/schema/SentencePieceTokenizerOptions$Vector;->bb:Ljava/nio/ByteBuffer;

    invoke-static {v0, v1}, Lorg/tensorflow/lite/support/metadata/schema/SentencePieceTokenizerOptions;->access$000(ILjava/nio/ByteBuffer;)I

    move-result v0

    iget-object v1, p0, Lorg/tensorflow/lite/support/metadata/schema/SentencePieceTokenizerOptions$Vector;->bb:Ljava/nio/ByteBuffer;

    invoke-virtual {p1, v0, v1}, Lorg/tensorflow/lite/support/metadata/schema/SentencePieceTokenizerOptions;->__assign(ILjava/nio/ByteBuffer;)Lorg/tensorflow/lite/support/metadata/schema/SentencePieceTokenizerOptions;

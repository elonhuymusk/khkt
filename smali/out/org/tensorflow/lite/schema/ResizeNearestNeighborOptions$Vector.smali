...
.method public get(Lorg/tensorflow/lite/schema/ResizeNearestNeighborOptions;I)Lorg/tensorflow/lite/schema/ResizeNearestNeighborOptions;
    ...
    iget-object v1, p0, Lorg/tensorflow/lite/schema/ResizeNearestNeighborOptions$Vector;->bb:Ljava/nio/ByteBuffer;

    invoke-static {v0, v1}, Lorg/tensorflow/lite/schema/ResizeNearestNeighborOptions;->access$000(ILjava/nio/ByteBuffer;)I

    move-result v0

    iget-object v1, p0, Lorg/tensorflow/lite/schema/ResizeNearestNeighborOptions$Vector;->bb:Ljava/nio/ByteBuffer;

    invoke-virtual {p1, v0, v1}, Lorg/tensorflow/lite/schema/ResizeNearestNeighborOptions;->__assign(ILjava/nio/ByteBuffer;)Lorg/tensorflow/lite/schema/ResizeNearestNeighborOptions;

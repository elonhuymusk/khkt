...
.method public get(Lorg/tensorflow/lite/schema/WhileOptions;I)Lorg/tensorflow/lite/schema/WhileOptions;
    .registers 5
    .param p1, "obj"    # Lorg/tensorflow/lite/schema/WhileOptions;
    .param p2, "j"    # I
    ...
    iget-object v1, p0, Lorg/tensorflow/lite/schema/WhileOptions$Vector;->bb:Ljava/nio/ByteBuffer;

    invoke-static {v0, v1}, Lorg/tensorflow/lite/schema/WhileOptions;->access$000(ILjava/nio/ByteBuffer;)I

    move-result v0

    iget-object v1, p0, Lorg/tensorflow/lite/schema/WhileOptions$Vector;->bb:Ljava/nio/ByteBuffer;

    invoke-virtual {p1, v0, v1}, Lorg/tensorflow/lite/schema/WhileOptions;->__assign(ILjava/nio/ByteBuffer;)Lorg/tensorflow/lite/schema/WhileOptions;

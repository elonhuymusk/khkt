...
.method public get(Lorg/tensorflow/lite/schema/AddOptions;I)Lorg/tensorflow/lite/schema/AddOptions;
    .registers 5
    .param p1, "obj"    # Lorg/tensorflow/lite/schema/AddOptions;
    .param p2, "j"    # I
    ...
    iget-object v1, p0, Lorg/tensorflow/lite/schema/AddOptions$Vector;->bb:Ljava/nio/ByteBuffer;

    invoke-static {v0, v1}, Lorg/tensorflow/lite/schema/AddOptions;->access$000(ILjava/nio/ByteBuffer;)I

    move-result v0

    iget-object v1, p0, Lorg/tensorflow/lite/schema/AddOptions$Vector;->bb:Ljava/nio/ByteBuffer;

    invoke-virtual {p1, v0, v1}, Lorg/tensorflow/lite/schema/AddOptions;->__assign(ILjava/nio/ByteBuffer;)Lorg/tensorflow/lite/schema/AddOptions;
